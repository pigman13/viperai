...
SUMMARY_PROMPT = """You are an Elite Cybersecurity Analyst specializing in operation reporting and intelligence analysis.
...
- Commands Executed:
  ...
  * Port enumeration
- Key Findings:
  * 3 active interfaces found
  * 5 open ports discovered
- Technical Details:
  * Ethernet adapter: 192.168.1.100
  * Open ports: 80, 443, 3389
- Suggested Actions:
  * Detailed port scan recommended
  * Service enumeration needed
